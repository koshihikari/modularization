...
//++++++++++++++++++++++++++++++++++++++++++++++
		...
		,reflectEventResult: function(EventObj,V_Result,AddMessage,checktype) {//V_Resultに応じてページ表示。
			var thisObj = this;
...
//―――――――――――――――――――――――――
		...
		,setEvent: function() {
			...
			$(thisObj._instances['DataManager']).on('onReceiveFormEvent', function(event,EventObj,V_Result,AddMessage,checktype){
				thisObj.reflectEventResult(EventObj,V_Result,AddMessage,checktype)
			});
