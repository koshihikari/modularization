...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		...
		,setEvent: function() {
			...
			thisObj._instances['AutoEmManager']					.setEvent(true)
			thisObj._instances['SubmitCheckManager']			.setEvent(true)
			thisObj._instances['TimerSolutionManager']			.setEvent(true)

			thisObj._instances['RemainingItemsManager']			.setEvent(true)

			thisObj._instances['MultiItemsManager']				.setIniSettings()
			thisObj._instances['MultiItemsManager']				.makeItems()
			thisObj._instances['MultiItemsManager']				.setEvent(true)
			thisObj._instances['ConfigManager']					.setEvent(true)
			thisObj._instances['ValidateManager']				.setEvent(true)
			thisObj._instances['AutoAddressManager']			.setEvent(true)

			thisObj._instances['RemainingItemsManager']			.firstrRemainingItemsCheck()
			thisObj._instances['RemainingItemsManager']			.draggableDiv()
			thisObj.setTimer()
