...
jQuery(document).ready(function($){
	...
	MYNAMESPACE.namespace('model.ConfigManagerYutorishia');
	MYNAMESPACE.model.ConfigManagerYutorishia = function() {
		this.initialize.apply(this, arguments);
	};
	MYNAMESPACE.model.ConfigManagerYutorishia.prototype = {
		 _instances			: {}
		 ,_classname		: []
		 ,_idname			: []
		 ,_Validation		: {}
...
/*――――――――――――――*/
		,SetIdname: function() {
			var thisObj = this;
				$('form>table>tbody>tr>td>table:eq(1)>tbody>tr:eq(3)>td').attr('id','formtdID')
				var formtable = $('#formtdID>table').addClass('formtable')
...
//マウスオーバー
/*main*/			,{'Selecter'	: $('#formtdID>table:eq(0)>tbody>tr>td:has(input[type="radio"]):eq(0)')		,'id': 'RadioID_1'}
/*main*/			,{'Selecter'	: $('#formtdID>table:eq(0)>tbody>tr>td:has(input[type="radio"]):eq(1)')		,'id': 'RadioID_2'}
/*個人情報*/			,{'Selecter'	: $('#formtdID>div>table:eq(1)>tbody>tr:eq(1)')							,'id': 'RadioID_3'}
/*ご入会**/			,{'Selecter'	: $('#formtdID>table:eq(2)>tbody>tr:eq(2)>td:eq(1)')		,'id': 'RadioID_4'}
				]
...
/*main*/			,{'Selecter'	: $('#formtdID>table:eq(0)>tbody>tr>td:has(input,select)')		,'classname': 'MouseoverEvent'}
/*その他*/			,{'Selecter'	: $('#formtdID>table:eq(1) td')									,'classname': 'MouseoverEvent'}
/*個人情報*/			,{'Selecter'	: $('#RadioID_3')							,'classname': 'MouseoverEvent'}
/*ご入会**/			,{'Selecter'	: $('#formtdID>table:eq(2)>tbody>tr:eq(0)>td:eq(1)') 			,'classname': 'MouseoverEvent'}
/*ご入会**/			,{'Selecter'	: $('#RadioID_4') 												,'classname': 'MouseoverEvent'}
...
/*radioのinput*/							,{'Selecter'	: $('#RadioID_3 input[type="radio"]') 							,'classname': 'ValidationRadioInput'}
// /*radioのinput*/							,{'Selecter'	: formtable.eq(0).find('input[type="radio"]') 							,'classname': 'ValidationRadioInput'}
/*radio未選択の際に色を付けたい場所*/		,{'Selecter'	: $('#formtdID>table:eq(0)>tbody>tr>td:has(input[type="radio"])').not('td:has(input[name="col_18"])') 					,'classname': 'ValidationRadioTd'}
/*radio未選択の際に色を付けたい場所*/		,{'Selecter'	: $('#RadioID_3')														,'classname': 'ValidationRadioTd'}
/*checkboxのinput*/						,{'Selecter'	: $('input[type="checkbox"]') 											,'classname': 'ValidationCheckboxInput'}
/*checkbox未選択の際に色を付けたい場所*/		,{'Selecter'	: $('#formtdID>table:eq(2)>tbody>tr:eq(0)>td:eq(1)') 							,'classname': 'ValidationCheckboxTd'}
/*checkbox未選択の際に色を付けたい場所*/		,{'Selecter'	: $('#RadioID_4') 												 				,'classname': 'ValidationCheckboxTd'}
...
/*					*/	 col_4				: "chkrequired"
/*					*/	,col_5				: "chkrequired"
/*					*/	,col_14				: "chkrequired chkkatakana"
/*					*/	,col_15				: "chkrequired chkkatakana"
...
/*					*/	,col_16				: "chknumonly chkrequired chkyear"
/*					*/	,col_16_2			: "chknumonly chkrequired chkmonth"
/*					*/	,col_16_3			: "chknumonly chkrequired chkday"
/*					*/	,col_17				: "chknumonly chkrequired chkage"
/*					*/	,choice1			: "chknumonly chkrequired chkmonth"
/*					*/	,choice1_2			: "chknumonly chkrequired chkday"
/*					*/	,choice1_3			: "chknumonly chkrequired chktime"
/*					*/	,choice2			: "chknumonly chkrequired chkmonth"
/*					*/	,choice2_2			: "chknumonly chkrequired chkday"
/*					*/	,choice2_3			: "chknumonly chkrequired chktime"
