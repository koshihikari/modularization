...
// //for yuraku　↓―――――――――――――――――――――――――――――――――――
// 							var FirstBlank = $j('form.NT_mainForm .blank').eq(0)
...
// //for yuraku　↑―――――――――――――――――――――――――――――――――――
							if($('html').hasClass('ie') === true){//placeholderの値削除(IE)
								var targetY = $j('form.NT_mainForm .blank').eq(0).offset().top - 100;
								$j('body,html').animate({scrollTop: targetY}, 0);
								$j('form.NT_mainForm .blank').eq(0).blur();
								$('input:not(input[type="radio"])').blur()
							} else {
								var targetY = $('form.NT_mainForm .blank').eq(0).offset().top - 100;
								$j('form.NT_mainForm .blank').eq(0).blur();
