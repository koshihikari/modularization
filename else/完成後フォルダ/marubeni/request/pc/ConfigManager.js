...
/*――――――――――――――*/
		,SetIdname: function() {
			var thisObj = this;
				...
				thisObj._idname =	[
					 {'Selecter'	: $('input[name="tel_guide"][value="1"]') 			,'id': 'tel_guide_1'}
					,{'Selecter'	: $('input[name="tel_guide"][value="0"]') 			,'id': 'tel_guide_2'}
...
// 					,{'Selecter'	: $('#agree_privacy').closest('.font2_1') 					,'id': 'RadioID_4'}
		...
		,SetClassname: function() {
			var thisObj = this;
				...
				thisObj._classname =	[
//Placeholder
					 {'Selecter'	: $('#name1') 							,'classname': 'firstName'}
					,{'Selecter'	: $('#name2') 							,'classname': 'lastName'}
					,{'Selecter'	: $('#kana1') 							,'classname': 'firstNameKatakana'}
					,{'Selecter'	: $('#kana2') 							,'classname': 'lastNameKatakana'}
					,{'Selecter'	: $('#zip1')							,'classname': 'Address_Num_1st'}
					,{'Selecter'	: $('#zip2')							,'classname': 'Address_Num_2nd'}
					// ,{'Selecter'	: $('#ken') 							,'classname': 'Address_text_1st'}
					,{'Selecter'	: $('#city') 							,'classname': 'Address_text_123tyome'}
					,{'Selecter'	: $('#address') 						,'classname': 'Address_text_tyomeafter'}
					,{'Selecter'	: $('#email3') 							,'classname': 'MailBefore'}
					,{'Selecter'	: $('#email4') 							,'classname': 'MailAfter'}
					,{'Selecter'	: $('#email1') 							,'classname': 'MailBefore'}
					,{'Selecter'	: $('#email2') 							,'classname': 'MailAfter'}
					// ,{'Selecter'	: $('#email2') 							,'classname': 'Mail'}
					,{'Selecter'	: $('#tel1')							,'classname': 'Tel3_1'}
					,{'Selecter'	: $('#tel2')							,'classname': 'Tel3_2'}
					,{'Selecter'	: $('#tel3')							,'classname': 'Tel3_3'}
...
// //住所自動入力
					...
					,{'Selecter'	: $('#zip1') 				,'classname': 'AutoAddressNum1'}
					,{'Selecter'	: $('#zip2') 				,'classname': 'AutoAddressNum2'}
					// ,{'Selecter'	: $('input[name="col_21"]') 			,'classname': 'AutoAddressText1'}

					,{'Selecter'	: $('#city') 				,'classname': 'AutoAddressText1'}


					// ,{'Selecter'	: $('#aaa') 				,'classname': 'AutoAddressNum1'}
					// ,{'Selecter'	: $('#bbb') 				,'classname': 'AutoAddressNum2'}
					// ,{'Selecter'	: $('#111') 				,'classname': 'AutoAddressText1'}
					// ,{'Selecter'	: $('#222') 				,'classname': 'AutoAddressText2'}
					// ,{'Selecter'	: $('#333') 				,'classname': 'AutoAddressText3'}
...
/*radioのinput*/							,{'Selecter'	: $('#lavel7_1,#tel_guide_1,#tel_guide_2') 												,'classname': 'ValidationRadioInput'}
/*radio未選択の際に色を付けたい場所*/		,{'Selecter'	: $('#lavel7_1').closest('td') 									,'classname': 'ValidationRadioTd'}
/*radio未選択の際に色を付けたい場所*/		,{'Selecter'	: $('#tel_guide_1').closest('td') 									,'classname': 'ValidationRadioTd'}
/*checkboxのinput*/						,{'Selecter'	: $('#lavel2_1,#lavel2_2,#lavel2_3,#lavel2_4,#lavel3_1,#lavel3_2,#lavel3_3,#lavel3_4,#accept') 		,'classname': 'ValidationCheckboxInput'}
/*checkboxのinput*/						,{'Selecter'	: $('#wrap>ul.form-dwelling02 input[type="checkbox"]') 			,'classname': 'ValidationCheckboxInput'}
/*checkbox未選択の際に色を付けたい場所*/	,{'Selecter'	: $('#wrap>ul.form-dwelling02>li') 									,'classname': 'ValidationCheckboxTd'}//個人情報１
...
/*checkbox未選択の際に色を付けたい場所*/	,{'Selecter'	: $('#accept').closest('div') 									,'classname': 'ValidationCheckboxTd'}//個人情報１
...
/*					*/	 name1				: "chkrequired"
/*					*/	,name2				: "chkrequired"
/*					*/	,kana1				: "chkrequired chkkatakana"
/*					*/	,kana2				: "chkrequired chkkatakana"
/*					*/	,zip1				: "chkrequired chknumonly chk3num"
/*					*/	,zip2				: "chkrequired chknumonly chk4num"
// /*					*/	,user_ken			: "chkrequired "
// /*					*/	,city				: "chkrequired "
/*					*/	,address			: "chkrequired "
/*					*/	,email3				: "chkrequired chkemailbefore chkhankaku"
/*					*/	,email4				: "chkrequired chkemailafter chkhankaku"
/*					*/	,email1				: "chkrequired chkretype-email3"
/*					*/	,email2				: "chkrequired chkretype-email4"
// /*					*/	,user_eml			: "chkrequired chkemail chkhankaku chkretype-email3"
/*					*/	,tel1				: "chkrequired chknumonly"
/*					*/	,tel2				: "chkrequired chknumonly"
/*					*/	,tel3				: "chkrequired chknumonly"
...
/*――――――――――――――*/
		...
		,SetKana: function() {
			var thisObj = this;
			 thisObj._nameKana = ['name1','name2','kana1','kana2']
			$(thisObj).trigger('onSetKana');
		}
