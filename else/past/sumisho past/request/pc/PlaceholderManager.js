...
/*社名*/		$('input.firstName')				.attr('placeholder','住商')
			$('input.lastName')					.attr('placeholder','太郎')
/*社名*/		$('input.firstNameKatakana')		.attr('placeholder','スミショウ')
			$('input.lastNameKatakana')			.attr('placeholder','タロウ')
// /*社名*/		$('input.firstNameHiragana')		.attr('placeholder','にゅうりょく')
			// $('input.lastNameHiragana')			.attr('placeholder','たろう')
			$('input.Tel3_1')					.attr('placeholder','03')
			$('input.Tel3_2')					.attr('placeholder','1234')
			$('input.Tel3_3')					.attr('placeholder','5678')
			// $('input.Tel1_hyphen')				.attr('placeholder','03-xxxx-xxxx')
			// $('input.Tel1_nohyphen')			.attr('placeholder','03xxxxyyyy')
			$('input.BirthYear')				.attr('placeholder','1980')
			$('input.BirthMonth')				.attr('placeholder',' 1')
			$('input.Birthdate')				.attr('placeholder',' 1')
			$('input.Age')						.attr('placeholder','33')
			$('input.Familiy_Num')				.attr('placeholder','4')
/*社名*/		$('input.Mail')						.attr('placeholder','abc@abcdfgh.co.jp')
/*社名*/		$('input.MobileMail')				.attr('placeholder','abc@abcdfgh.co.jp')
...
// /*社名*/		$('input.Mail_afterAt')				.attr('placeholder','yuraku.co.jp')
			...
			$('input.Address_Num_1st')			.attr('placeholder','000')
			$('input.Address_Num_2nd')			.attr('placeholder','0001')
			// $('input.Address_text_1st')		.attr('placeholder','東京都')
			$('input.Address_text_2nd')			.attr('placeholder','中央区')
			$('input.Address_text_3rd')			.attr('placeholder','晴海１丁目')
			$('input.Address_text_4th')			.attr('placeholder','８－１１－１０１')
			$('input.Address_HouseName')		.attr('placeholder','クラッシィ〇〇')
			$('input.Familiy_Num')				.attr('placeholder','4')
			// $('input.Reserve_Month')			.attr('placeholder','4')
			// $('input.Reserve_Day')				.attr('placeholder','1')
			// $('input.Reserve_Time')				.attr('placeholder','14')
			$('input.CompanyName')				.attr('placeholder','住友商事株式会社')
			$('input.SelfMoney')				.attr('placeholder','600')
			$('input.AreaSize')					.attr('placeholder','80')
			$('input.HopeArea')					.attr('placeholder','世田谷区')
