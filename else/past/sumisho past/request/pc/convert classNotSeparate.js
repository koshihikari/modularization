...
//デフォルト記入例の削除―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
	...
	$('#txtCity,#txtDistrict,#txtAddress,#txtBuilding,#txtMailPC,#txtMailMobile').each(function(){
		...
		closestTd.html(tempDivNode.html()).append($('<span class="NT_zenkaku">').text(zenhankaku))
	})
	var closestTd = $('#txtMobilePhone1').closest('td')
	var tempPhoneNode = $('<div>')
							.append($('#txtMobilePhone1'))
							.append($('<span class="NT_hifun">').text('-'))
							.append($('#txtMobilePhone2'))
							.append($('<span class="NT_hifun">').text('-'))
							.append($('#txtMobilePhone3'))
							.append($('<span class="NT_zenkaku">').text('（半角数字）'))
...
//onアトリビュートの削除
	...
	$('#privacyID').html($('<label class="labelClass">').append(privacyTdClone))
