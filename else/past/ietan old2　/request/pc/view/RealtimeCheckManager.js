...
//有楽仕様↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
						thisClosestTd.removeClass('NT_blank');
//有楽仕様↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
					} else {
						thisClosestTd.addClass('NT_blank');
					}
//有楽仕様↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
				}
				//insertdiv処理
				...
				if(($(this).attr('name') === 'wellith') || ($(this).attr('name') === 'agree_privacy')){
					if($('input[name="wellith"]:checked').val() !== undefined){//wにチェックあり
						if($('input[name="agree_privacy"]:checked').val() === undefined){
							$('input[name="agree_privacy"]').closest('.ValidationCheckboxTd').addClass('NT_blank');
						} else {
							$('input[name="agree_privacy"]').closest('.ValidationCheckboxTd').removeClass('NT_blank');
						}
					} else {
						$('input[name="agree_privacy"]').closest('.ValidationCheckboxTd').removeClass('NT_blank');
					}
