...
jQuery(document).ready(function($){
	...
	MYNAMESPACE.namespace('model.ConfigManagerYokohama');
	MYNAMESPACE.model.ConfigManagerYokohama = function() {
		this.initialize.apply(this, arguments);
	};
	MYNAMESPACE.model.ConfigManagerYokohama.prototype = {
		 _instances			: {}
		 ,_classname		: []
		 ,_idname			: []
		 ,_Validation		: {}
...
/*――――――――――――――*/
		,SetIdname: function() {
			var thisObj = this;
				...
				$('form>table>tbody>tr>td>table>tbody>tr>td>center').attr('id','centerID')
				thisObj._idname =	[
...
/*個人情報*/			,{'Selecter'	: $('#centerID>table:eq(1)>tbody>tr:eq(1)')							,'id': 'RadioID_3'}
// /*個人情報*/			,{'Selecter'	: $('table.formtable:eq(3) tr:has(input,select)')							,'id': 'RadioID_3'}
/*ご入会**/			,{'Selecter'	: $('#centerID>table:eq(2)>tbody>tr:eq(2)>td:eq(1)')		,'id': 'RadioID_4'}
...
/*ご入会**/			,{'Selecter'	: $('#RadioID_4').closest('tr').children('td')		,'classname': 'MouseoverEvent'}
/*ご入会**/			,{'Selecter'	: $('#centerID>table:eq(2)>tbody>tr:eq(0)>td:eq(1)')		,'classname': 'MouseoverEvent'}
...
/*radioのinput*/							,{'Selecter'	: $('#RadioID_3 input[type="radio"][name="privacy"]') 							,'classname': 'ValidationRadioInput'}
// /*radioのinput*/							,{'Selecter'	: formtable.eq(0).find('input[type="radio"]') 							,'classname': 'ValidationRadioInput'}
