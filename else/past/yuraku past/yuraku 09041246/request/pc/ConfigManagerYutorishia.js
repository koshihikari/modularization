...
/*――――――――――――――*/
		,SetIdname: function() {
			var thisObj = this;
				$('#formID>table>tbody>tr>td').attr('id','formtdID')
				var formtableradio = $('#formtdID>table:eq(3)>tbody>tr>td:has(input[type="radio"])')
...
/*td*/				,{'Selecter'	: formtableradio.eq(0)								,'id': 'RadioID_1'}
					...
					,{'Selecter'	: $('#formtdID>table:eq(6)>tbody>tr:eq(1)>td') 	,'id': 'RadioID_3'}
...
/*td*/				,{'Selecter'	: $('#formtdID>table:gt(2):lt(5)>tbody>tr>td:has(input,select)')								,'classname': 'MouseoverEvent'}
					,{'Selecter'	: $('#RadioID_3') 												,'classname': 'MouseoverEvent'}
...
/*radioのinput*/							,{'Selecter'	: $('input[name="privacy"]') 												,'classname': 'ValidationRadioInput'}
...
/*――――――――――――――*/
		...
		,setSubmitComment: function() {
			...
			thisObj._SubmitCommentObj = {  'mailaddr'			: 'メールアドレス'
										 ...
										 , 'RadioID_2'			: 'ご希望の間取り'
										 , 'RadioID_3'			: '資料請求についての個人情報保護規約への同意'
