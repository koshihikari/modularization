...
/*社名*/		$('input.firstName')				.attr('placeholder','例：有楽')
			$('input.lastName')				.attr('placeholder','例：太郎')
/*社名*/		$('input.firstNameKatakana')		.attr('placeholder','例：ユウラク')
			$('input.lastNameKatakana')		.attr('placeholder','例：タロウ')
/*社名*/		$('input.firstNameHiragana')		.attr('placeholder','例：ゆうらく')
...
/*社名*/		$('input.Mail_afterAt')			.attr('placeholder','例：yuraku.co.jp')
			...
			$('input.Address_text_3rd')		.attr('placeholder','例：京橋')
			$('input.Address_text_4th')		.attr('placeholder','例：3-13-1')
			$('input.Address_HouseName')		.attr('placeholder','例：○○マンション101')
