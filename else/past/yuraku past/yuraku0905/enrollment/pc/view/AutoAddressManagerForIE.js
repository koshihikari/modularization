...
// alert($('#AutoAddressNum1').attr('name')+','+$('#AutoAddressNum2').attr('name')+','+$('#AutoAddressText1').attr('name')+','+$('#AutoAddressText2').attr('name')+','+$('#AutoAddressText3').attr('name'))
									// AjaxZip3.zip2addr($('#AutoAddressNum1').attr('name'),$('#AutoAddressNum2').attr('name'),$('#AutoAddressText1').attr('name'),$('#AutoAddressText2').attr('name'),'',$('#AutoAddressText3').attr('name'));
									// AjaxZip3.zip2addr('col_19[]','col_19[]','col_12','col_21','','col_22');
