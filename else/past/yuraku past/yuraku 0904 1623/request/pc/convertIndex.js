...
// alert('テスト用アラート／プライムクロス')
	jQuery('html').show();
//ブラウザ判定、body,formのid,class付与―――――――――――――――――――――――――――――――――――
	var userAgent = window.navigator.userAgent.toLowerCase();
	if(userAgent.search(/iphone/) == -1 && userAgent.search(/ipad/) == -1 && userAgent.search(/ipod/) == -1 && userAgent.search(/android/) == -1){
	...
	//convertYokohama.js――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
		if($('form>input[name="b_code"]').val() == 'B-101'){
	...
	/*有楽仕様*/			var thisname = $(this).attr('name').replace('[]','')
		...
		//事前コンバート―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
		//backgroundColorを削除―――――――――――――――――――――――――――――――――――
			$('form>table>tbody>tr>td>center>table:eq(1)>tbody>tr:eq(1)>td').attr('bgcolor','')
	...
	//convertYutorishia.js―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――
		} else if($('form>input[name="b_code"]').val() == 'B-29'){
