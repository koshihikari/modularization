...
//inlineblock,:empty displaynone
	...
	for (var i=0,len=labelNode.length; i<len; i++) {
		...
		var ddNode=$('<dd class="NT_DD_'+i+'">').append($('#divID>label:eq('+j+')').nextAll())
		var dtNode=$('<dt class="NT_DT_'+i+'">').append($('#divID>label:eq('+j+')'))
	...
	$('#divID').html(dlNode)
	$('input[name="col_13[]"]:not(:eq(2))').after($('<span class="fortext">').text('―'))
	$('input[name="col_16[]"]:eq(0)').before($('<span class="fortext">').text('西暦'))
	$('input[name="col_16[]"]:eq(1)').before($('<span class="fortext">').text('年'))
	$('input[name="col_16[]"]:eq(2)').before($('<span class="fortext">').text('月'))
	$('input[name="col_16[]"]:eq(2)').after($('<span class="fortext">').text('日'))
	$('#AddIDforSP_34').after($('<span class="fortext">').text('人'))
